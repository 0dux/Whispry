...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen p-4 text-base-content">
      {/* Card Wrapper */}
      <div className="relative flex items-center justify-center w-full max-w-6xl h-144 md:h-160">
        ...
        <div className="z-30 flex flex-col w-full h-full rounded-2xl bg-base-200 md:flex-row">
          ...
          {/* Right Column: Image */}
          <div
            className="relative hidden w-full h-full md:flex md:w-1/2 bg-neutral-300 rounded-2xl"
            style={{
